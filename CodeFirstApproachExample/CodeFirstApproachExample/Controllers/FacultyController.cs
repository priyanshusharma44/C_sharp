...
namespace CodeFirstApproachExample.Controllers
{
    public class FacultyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FacultyId,FacultyName,HodName")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FacultyId,FacultyName,HodName")] Faculty faculty)
        {
